	...
	return []Scenario{
		{
			...
			Profiles: map[string]SensorProfile{
				...
				"temp_kitchen":         {Value: 23, Noise: 0.5, Unit: "°C"},
				"humidity_kitchen":     {Value: 46, Noise: 2, Unit: "%"},
				"light_kitchen":        {Value: 100, Noise: 20, Unit: "lux"},
				"motion_kitchen":       {Value: 0, Noise: 0, Unit: ""},
				"temp_bedroom":         {Value: 21, Noise: 0.5, Unit: "°C"},
				"humidity_bedroom":     {Value: 44, Noise: 2, Unit: "%"},
		...
		},
		{
			...
			Profiles: map[string]SensorProfile{
				...
				"motion_living_room":   {Value: 1, Noise: 0, Unit: ""},
				"temp_kitchen":         {Value: 22, Noise: 0.5, Unit: "°C"},
				"humidity_kitchen":     {Value: 44, Noise: 2, Unit: "%"},
				"light_kitchen":        {Value: 20, Noise: 10, Unit: "lux"},
				"motion_kitchen":       {Value: 0, Noise: 0, Unit: ""},
				"temp_bedroom":         {Value: 20, Noise: 0.5, Unit: "°C"},
				"humidity_bedroom":     {Value: 42, Noise: 2, Unit: "%"},
		...
		},
		{
			...
			Profiles: map[string]SensorProfile{
				...
				"motion_living_room":   {Value: 1, Noise: 0, Unit: ""},
				"temp_kitchen":         {Value: 22, Noise: 0.5, Unit: "°C"},
				"humidity_kitchen":     {Value: 45, Noise: 2, Unit: "%"},
				"light_kitchen":        {Value: 10, Noise: 5, Unit: "lux"},
				"motion_kitchen":       {Value: 0, Noise: 0, Unit: ""},
				"temp_bedroom":         {Value: 21, Noise: 0.5, Unit: "°C"},
				"humidity_bedroom":     {Value: 43, Noise: 2, Unit: "%"},
		...
		},
		{
			...
			Profiles: map[string]SensorProfile{
				...
				"temp_kitchen":         {Value: 26, Noise: 0.5, Unit: "°C"},
				"humidity_kitchen":     {Value: 65, Noise: 3, Unit: "%"},
		...
		},
		{
			...
			Profiles: map[string]SensorProfile{
				...
				"motion_living_room":   {Value: 0, Noise: 0, Unit: ""},
				"temp_kitchen":         {Value: 18, Noise: 0.3, Unit: "°C"},
				"humidity_kitchen":     {Value: 40, Noise: 2, Unit: "%"},
				"light_kitchen":        {Value: 0, Noise: 0, Unit: "lux"},
				"motion_kitchen":       {Value: 0, Noise: 0, Unit: ""},
				"temp_bedroom":         {Value: 18, Noise: 0.3, Unit: "°C"},
				"humidity_bedroom":     {Value: 40, Noise: 2, Unit: "%"},
		...
		},
		{
			...
			Profiles: map[string]SensorProfile{
				...
				"motion_living_room":   {Value: 0, Noise: 0, Unit: ""},
				"temp_kitchen":         {Value: 22, Noise: 0.3, Unit: "°C"},
				"humidity_kitchen":     {Value: 45, Noise: 1, Unit: "%"},
				"light_kitchen":        {Value: 0, Noise: 0, Unit: "lux"},
				"motion_kitchen":       {Value: 0, Noise: 0, Unit: ""},
				"temp_bedroom":         {Value: 22, Noise: 0.3, Unit: "°C"},
				"humidity_bedroom":     {Value: 45, Noise: 1, Unit: "%"},
		...
		},
		{
			...
			Profiles: map[string]SensorProfile{
				...
				"motion_living_room":   {Value: 1, Noise: 0, Unit: ""},
				"temp_kitchen":         {Value: 28, Noise: 0.5, Unit: "°C"},
				"humidity_kitchen":     {Value: 54, Noise: 3, Unit: "%"},
				"light_kitchen":        {Value: 200, Noise: 20, Unit: "lux"},
				"motion_kitchen":       {Value: 0, Noise: 0, Unit: ""},
				"temp_bedroom":         {Value: 27, Noise: 0.5, Unit: "°C"},
				"humidity_bedroom":     {Value: 52, Noise: 3, Unit: "%"},
